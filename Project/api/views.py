...
from .permissions import IsAdmin, IsAdminOrReadOnly, IsOwnerOrIsAdminOrReadOnly
...
class ReviewViewSet(ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        review = Review.objects.filter(title_id=kwargs.get('title_id'), author_id=request.user.id)
        if review:
            raise ValidationError(detail='You have already written a review to this title')
